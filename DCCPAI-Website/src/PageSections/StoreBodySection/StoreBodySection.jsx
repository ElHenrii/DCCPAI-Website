...
function ShopBodySection() {
    ...
    const productsPerPage = 6;  // Define how many products per page
    ...
    useEffect(() => {
        ...
        loadCategories();
        loadBrands();
        loadProductBrands();  // Fetch the product-brand relationships
    }, []
    );
    ...
    // New: Filter by selected brand (based on the product-brand relationship)
